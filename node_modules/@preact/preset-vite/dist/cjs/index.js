...
const transform_hook_names_js_1 = require("./transform-hook-names.js");
...
function preactPlugin({ devtoolsInProd, devToolsEnabled, prefreshEnabled, reactAliasesEnabled, prerender, include, exclude, babel, jsxImportSource, } = {}) {
    ...
    const jsxPlugin = {
        ...
        enforce: "pre",
        config() {
            const supportsRolldown = this && "meta" in this && this.meta && typeof this.meta === "object"
    ...
    return [
        ...
        ...(!useBabel
            ? [
                (0, transform_hook_names_js_1.transformHookNamesPlugin)({
                    devtoolsInProd,
                    devToolsEnabled,
                    shouldTransform,
                }),
